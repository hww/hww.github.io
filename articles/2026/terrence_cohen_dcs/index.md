...
Существует два способа проверки условий:

1. **Обновляемые (Updated):** Автоматически обновляются системой компонентов и опрашивают свои условия каждый кадр.
2. **Уведомляемые (Notified):** Ожидают уведомления от игрового процесса о наступлении события.
...
* Они обновляются навигационной системой, а не автоматически системой компонентов.
