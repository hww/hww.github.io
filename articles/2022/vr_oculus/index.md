...
|![Complex Mesh 4244 треугольников](images/figure_complex.png)|
| :---: |
| *Figure 6 — Complex Mesh: 4244 треугольника, много деталей.* |

|![Simple Mesh 1236 треугольников](images/figure_simple.png)|
| :---: |
| *Figure 7 — Simple Mesh: 1236 треугольников, деталей меньше.* |
...
|![Проблема Skydome](images/figure_skydome.png)|
| :---: |
| *Figure 8 — Skydome. Объект находится близко к центру, но должен рендериться последним.* |

|![Самопересечение](images/figure4.png)|
| :---: |
| *Figure 9 — Самопересекающаяся геометрия. Такие объекты стоит разбивать на две непересекающиеся части.* |
...
|![Tight Mesh Sprite](images/tight_mesh_sprite.png)|
| :---: |
| *Figure 8 — Tight Mesh Sprite* |

|![Самопересечение](images/sprite_renderer.png)|
| :---: |
| *Figure 9 — Самопересекающаяся геометрия. Такие объекты стоит разбивать на две непересекающиеся части.* |
